    ...
    public void openShop()
    {
        if (name != null)
        {
            ...
            if (name.contains("Pet Shop"))
            {
                ...
                {
                    p.sendMessage(ChatColor.GRAY + " You have " + ChatColor.LIGHT_PURPLE + hubPrefixes.yourcredits + ChatColor.GRAY + " creditsSTG.");
                    e.setCancelled(true);
                    //gui here
